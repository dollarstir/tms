...
<head>
    ...
    <title>TUCEE - Salary Records</title>
                                    ...
                                    <!-- Datatable with export options -->
                                     <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                        <div class="widget-content widget-content-area br-6">
                                            <h4 class="table-header">Salary Records</h4>
                                            <div class="table-responsive mb-4">
                                                <table id="export-dt" class="table table-hover" style="width:100%">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            $tb = new Sel();
                                                            $all =  $tb->getall("salary");
                                                            // foreach ($all as $row){
                                                            //    
                                                                
                                                            // }

                                                            Folop::foe($all,function($row){
                                                                $tb = new Sel();
                                                                $cid = $row['cid'];
                                                                    $c = $tb->select("staff",
                                                                    [
                                                            ...
                                                            <td>  <button  class="btn btn-danger delsalary" id="'.$row['id'].'"><i class="las la-trash"></i></button>  </td>
                                                            </tr>
