...
<head>
    ...
    <title>TUCC - Events Executed </title>
                        ...
                        <li>
                            <div class="page-header">
                                <nav class="breadcrumb-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Events Executed</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><span>Add Events Executed</span></li>
                                    </ol>
                                </nav>
                            </div>
                        </li>
                                        ...
                                        <form class="eventex">
                                            <div class="statbox widget box box-shadow mb-4">
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    <div class="w-100">
                                                        <div class="mt-2">
                                                            <input type="text" name="title" placeholder="Event Title"  class="form-control mb-3" /> 
                                                    <input type="text" name="venue" placeholder="Venue"  class="form-control mb-3" /> 
                                                    <input type="number" name="rate" placeholder="Rate"  class="form-control mb-3" />
                                                    <div class="form-group row">
                                                        <label class="col-3">Date</label>
                                                        <div class="col-9">
                                                            <input class="form-control form-control-solid" type="date" name="edate" >
                                                        </div>
                                                    </div>
                                            

                                                    <input type="number" name="edays" placeholder="Days Taken"  class="form-control mb-3" /> 
                                                    <input type="number" name="males" placeholder="Male Attendance"  class="form-control mb-3" /> 
