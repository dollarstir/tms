...
<head>
    ...
    <title>TUCEE - Edit Bookings </title>
                                                    ...
                                                    <div class="w-100">
                                                        <div class="mt-2">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-solid" type="date"  name="bookdate" value="<?php say($r[0]['bookdate']);?>">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-solid" type="time"  name="booktime" value="<?php say($r[0]['booktime']);?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12">
                                                                    <select class="form-control placeholdertc select2-hidden-accessible" data-select2-id="15" tabindex="-1" aria-hidden="true" name="toc" value="<?php say($r[0]['toc']);?>">
                                                                        <!-- <option data-select2-id="16"></option> -->
                                                                        <option value="<?php say($r[0]['toc']);?>" selected> <?php say($r[0]['toc']);?></option>
                                                            ...
                                                            <br>
                                                    <input type="text" name="assigned" placeholder="Assigned Counsellor"  class="form-control mb-3" value="<?php say($r[0]['assigned']);?>" /> 
                                                    <input type="text" name="hyh" placeholder="How you heard of TUCEE"  class="form-control mb-3" value="<?php say($r[0]['hyh']);?>" /> 
