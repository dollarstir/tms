                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                           ...
                                                           foreach ($all as $row) {
                                                            ...
                                                            <td> '.$row['phone'].'</td>
                                                            <td> <a href="/tms/visitor_edit.php?id='.$row['id'].'"  title="Edit" class="btn btn-secondary"><i class="las la-edit"></i> Edit</a> <button id="'.$row['id'].'"  class="btn btn-danger delvisitor">Delete</button>  </td>
                                                        </tr>
