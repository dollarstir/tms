                                                                    ...
                                                                    <form id="msform" class="addstaff">
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-card">
                                                                                ...
                                                                                <input type="text" name="fname" placeholder="First Name"  class="form-control mb-3" value="<?php say($user[0]['name']) ;?>" /> 
                                                                                <input type="text" name="lname" placeholder="Last Name"  class="form-control mb-3" value="<?php say($lname) ;?>"/> 
