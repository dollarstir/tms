...
L.marker([51.5, -0.09])
  .addTo(mymap1)
  .bindPopup("<b>Hello world!</b><br />It's a popup.")
  .openPopup();
...
var LeafIcon = L.Icon.extend({
  options: {
    shadowUrl: "common-common-assets/img/leaflet-shadow.png",
    iconSize: [35, 41],
    shadowSize: [35, 41],
    iconAnchor: [22, 94],
    shadowAnchor: [20, 92],
...
var redIcon = new LeafIcon({
    iconUrl: "common-common-assets/img/leaflet-red.png",
  }),
  blueIcon = new LeafIcon({
    iconUrl: "common-common-assets/img/leaflet-blue.png",
  }),
  orangeIcon = new LeafIcon({
    iconUrl: "common-common-assets/img/leaflet-orange.png",
  });
L.marker([51.5, -0.09], { icon: redIcon })
  .bindPopup("I am a red marker.")
  .addTo(mymap3);
L.marker([51.495, -0.083], { icon: blueIcon })
  .bindPopup("I am a blue marker.")
  .addTo(mymap3);
L.marker([51.49, -0.1], { icon: orangeIcon })
  .bindPopup("I am an orange marker.")
  .addTo(mymap3);
...
mymap4.attributionControl.addAttribution(
