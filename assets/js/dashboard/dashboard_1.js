try {
  ...
  var options14 = {
    series: [
      {
        name: "Users",
        data: [7550, 7590, 7530, 7500, 7520, 7590, 7580],
      },
    ],
    chart: {
      height: 250,
      ...
      events: {
        mounted: function (ctx, config) {
          ...
          ctx.addPointAnnotation({
            ...
            customSVG: {
              SVG:
                '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#009688" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
              cssClass: undefined,
              offsetX: -8,
              offsetY: 5,
            },
  ...
  var options9 = {
    ...
    fill: {
      ...
      image: {
        src: [
          "common-common-assets/img/instagram-icon.png",
          "common-common-assets/img/facebook-icon.png",
        ],
        width: 40,
        height: 40,
      },
  ...
  var chart14 = new ApexCharts(
    document.querySelector("#totalUsersChart"),
    options14
  );
  chart14.render();
  /* User Progress - Render */
  var chart15 = new ApexCharts(
    document.querySelector("#user-progress"),
    options15
  );
  chart15.render();
  ...
  chart.render();
  /* Order Status - Render */
  var chart = new ApexCharts(document.querySelector("#orderStatus"), options3);
  chart.render();
  /* Daily Sales - Render */
  ...
  d_2C_1.render();
  /* Target Sales - Render */
  var chart = new ApexCharts(document.querySelector("#targetSales"), options4);
  chart.render();
  ...
  chart.render();
  /* Items Sold - Render */
  var chart = new ApexCharts(document.querySelector("#item-sold"), options8);
  chart.render();
