...
<head>
    ...
    <title>TUCEE  | Edit Session </title>
...
<body>
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    <div class="w-100">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <!-- <input type="text" name="name_of_customer" placeholder="Name of Customer"  class="form-control mb-3" />  -->
                                                    <input type="text" name="presissue" placeholder="Presenting Issues"  class="form-control mb-3" value="<?php say($r[0]['presissue']);?>"/> 
                                                    <input type="text" name="intervgiven" placeholder="Intervention Given"  class="form-control mb-3" value="<?php say($r[0]['intervgiven']);?>" />
                                                    <input type="text" name="assignment" placeholder="Assignment"  class="form-control mb-3" value="<?php say($r[0]['assignment']);?>"/> 
                                                    <input type="text" name="remarks" placeholder="General Remarks"  class="form-control mb-3"   value="<?php say($r[0]['remarks']);?>"/> 
                                                    <input type="hidden" name="id" placeholder="General Remarks"  class="form-control mb-3"   value="<?php say($r[0]['id']);?>"/> 
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-solid" type="date" name="datenext" value="<?php say($r[0]['datenext']);?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-7">
                                                                    <h5 class="fs-title mb-4"> Upload Psychometric Text:</h2>
                                                                </div>
                                                                <!-- <div class="col-5">
                                                            ...
                                                            <div class="attached-files">
                                                                <embed src="/tms/upload/<?php say($r[0]['psycotest']);?>"  width="320" height="200px;">
                                                            </div>
                                                            ...
                                                            <input  name="psycotest" type="file"  value="<?php say($r[0]['psycotest']);?>">


                                                            <br><br><br>
                                                            <div class="row">
                                                                <div class="col-7">
                                                                    <h5 class="fs-title mb-4"> Upload Copy of Report:</h2>
                                                                </div>
                                                                <!-- <div class="col-5">
                                                                    <h2 class="steps">Step 3 - 4</h2>
                                                                </div> -->
                                                            ...
                                                            <div class="attached-files">
                                                            <embed src="/tms/upload/<?php say($r[0]['report']);?>"  width="320" height="200px;">
                                                            </div>
                                                            <!-- <label for="file-upload" class="custom-file-upload mb-0">
                                                                <a title="Attach a file" class="mr-2 pointer text-primary">
                                                                    <i class="las la-paperclip font-20"></i>
                                                            ...
                                                            <input  name="report" type="file"  value="<?php say($r[0]['report']);?>">
    ...
    <script src="/tms/common-assets/plugins/select2/select2.min.js"></script>
    <script src="/tms/assets/js/forms/custom-select2.js"></script>   
