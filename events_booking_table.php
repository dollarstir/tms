                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                           ...
                                                           foreach ($all as $row) {
                                                            ...
                                                            <td> '.$row['cpaddress'].'</td>
                                                            <td> '.$row['cpcontact'].'</td>
                                                            <td><a href="/tms/eventbooked/'.$row['id'].'"  title="Edit" class="btn btn-secondary"><i class="las la-edit"></i> Edit</a> <button id="'.$row['id'].'"  class="btn btn-danger delevntb">Delete</button>  </td>
                                                        </tr>
