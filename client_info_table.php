                                                    ...
                                                    <tbody>
                                                         ...
                                                         <?php
                                                           ...
                                                           foreach ($all as $row) {
                                                            ...
                                                            <td>'.$row['ename'].'</td>
                                                            <td> '.$row['econt1'].'</td>
                                                            <td> <a href="/tms/client_edit.php?id='.$row['id'].'"  title="Edit" class="btn btn-secondary"><i class="las la-edit"></i> Edit</a> <button id="'.$row['id'].'"  class="btn btn-danger delclient"><i class="las la-trash"></i>Delete</button>  </td>
                                                        </tr>
