                                    ...
                                    <!-- Datatable with export options -->
                                     <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                                        <div class="widget-content widget-content-area br-6">
                                            <h4 class="table-header">Customers</h4>
                                                    ...
                                                    <tbody>
                                                         ...
                                                         <?php
                                                           ...
                                                           foreach ($all as $row) {
                                                            ...
                                                            <td>'.$row['ename'].'</td>
                                                            <td> '.$row['econt1'].'</td>
                                                            <td> <a href="/tms/customer_edit.php?id='.$row['id'].'"  title="Edit" class="btn btn-secondary"><i class="las la-edit"></i> Edit</a> <button id="'.$row['id'].'"  class="btn btn-danger delcustomer"><i class="las la-trash"></i>Delete</button>  </td>
                                                        </tr>
