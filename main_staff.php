...
<head>
    ...
    <title>TUCEE | Staff <?php echo $data[0];?> </title>
                                                                    ...
                                                                    <form id="msform" class="">
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-card">
                                                                                ...
                                                                                <input type="text" name="fname" placeholder=" Name"  class="form-control mb-3" value="<?php say($user[0]['name']) ;?>" /> 
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                    <input class="form-control form-control-solid" type="text"  name="gender" value="<?php say($user[0]['gender']) ;?>">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                    <input class="form-control form-control-solid" type="text"  name="mstatus" value="<?php say($user[0]['mstatus']) ;?>">
                                                                                        <!-- <select class="list-dt" id="year" name="expyear">
                                                                                            <option selected>Year</option>
                                                                                        </select>  -->
                                                                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                    <input class="form-control form-control-solid" type="text"  name="gender" value="<?php say($user[0]['religion']) ;?>">
                                                                                        <!-- <select class="list-dt" id="year" name="expyear">
                                                                                            <option selected>Year</option>
                                                                                        </select>  -->
                                                                                    </div>
                                                                                ...
                                                                                <input type="text" name="hedu" placeholder="Highest Education"  class="form-control mb-3" value="<?php say($user[0]['hedu']);?>" /> 
                                                                                ...
                                                                                <img src="/tms/upload/<?php say($user[0]['pic']) ;?>" style="width:150px;height:150px;">
                                                                                <br><br><br>
                                                                                ...
                                                                                <embed  src="/tms/upload/<?php say($user[0]['doc']);?>" width="100%" height="500">
                                                                                <br><br><br>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                    <input type="text"   class="form-control mb-3" value="<?php say($user[0]['department']);?>" />
                                                                                        <!-- <select class="list-dt" id="year" name="expyear">
                                                                                            <option selected>Year</option>
                                                                                        </select>  -->
                                                                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                    <input class="form-control form-control-solid"  name="datestarted" value="<?php say($user[0]['slevel']);?>">
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-card">
                                                                                ...
                                                                                <input type="text" name="efname" placeholder="Name"  class="form-control mb-3" value="<?php say($user[0]['ename']);?>"  /> 
                                                                                ...
                                                                                <label class="col-3">Name</label>
                                                                                <input type="text" name="nokfname" placeholder=" Name"  class="form-control mb-3" value="<?php say($user[0]['nokname']);?>"/> 
