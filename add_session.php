                            ...
                            <div class="page-header">
                                <nav class="breadcrumb-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><span>Add Seesion</span></li>
                                    </ol>
                                </nav>
                            </div>
                        </li>
                                        ...
                                        <form class="addsession">
                                            <div class="statbox widget box box-shadow mb-4">
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    ...
                                                    <input type="text" name="presissue" placeholder="Presenting Issues"  class="form-control mb-3" /> 
                                                    <input type="text" name="intervgiven" placeholder="Intervention Given"  class="form-control mb-3" />
                                                    <input type="text" name="assignment" placeholder="Assignment"  class="form-control mb-3" /> 
                                                    <input type="text" name="remarks" placeholder="General Remarks"  class="form-control mb-3" /> 
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-solid" type="date" name="datenext">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-7">
                                                            ...
                                                            <input  name='psycotest' type="file"  >
