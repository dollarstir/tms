...
<head>
    ...
    <title>TUCEE | TUCEE - Add Visitor </title>
                            ...
                            <div class="page-header">
                                <nav class="breadcrumb-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><span>Add Visitor</span></li>
                                    </ol>
                                </nav>
                            </div>
                        </li>
                                                ...
                                                <div class="w-100">
                                                    <div class="mt-2">
														...
														<div class="form-group row">
															...
															<div class="col-9">
																<input class="form-control form-control-solid" type="time" name="checkin" >
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Time out</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="time" placeholder="select time"  name="checkout">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Date Visited</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="date" placeholder="choose date" name="datevisited">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Purpose</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="text" placeholder="Purpose for the visit" name="purpose">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Remark's</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="text" placeholder="Remarks" name="remarks">
															</div>
														</div>
														<div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <input class="form-control form-control-solid" type="text" placeholder="P.O. Box 283 8562 Fusce Rd." name="address1">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-3">Address Line 2</label>
                                                            <div class="col-9">
                                                                <input class="form-control form-control-solid" type="text" placeholder="8562 Fusce Rd." name="address2">
                                                            </div>
                                                        </div>
                                                        <!-- <div class="form-group row">
