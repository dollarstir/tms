...
<head>
    ...
    <title>TUCEE | Edit Visitor </title>
    ...
    <link href="/tms/assets/css/loader.css" rel="stylesheet" type="text/css" />
    <link href="/tms/common-assets/plugins/animate/animate.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="page-header">
                                <nav class="breadcrumb-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><span>Edit Visitor</span></li>
                                    </ol>
                                </nav>
                            </div>
                        </li>
                        ...
                        <div class="row">
                            <div class="container p-0">
                                <div class="row layout-top-spacing">
                                    ...
                                    <?php
                                        $g = new Sel();
                                       $r= $g->select('visitors',[['id','=',$_GET['id']]]);



                                    ?>
                                    <form class="editvisitor">
                                    <div class="col-lg-12 layout-spacing">
                                        <div class="statbox widget box box-shadow mb-4">
                                            <div class="widget-header">
                                                <div class="row">
                                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                        ...
                                                        <div class="makeitSticky z">
                                                            <h4>Edit  <?php say($r[0]['name']);?> records</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="widget-content widget-content-area">
                                                <div class="w-100">
                                                    <div class="mt-2">
														...
														<div class="form-group row">
															<label class="col-3">Time in</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="time" name="checkin"  value="<?php say($r[0]['checkin']);?>">
                                                                <input class="form-control form-control-solid" type="hidden" name="id"  value="<?php say($r[0]['id']);?>">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Time out</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="time" placeholder="select time"  name="checkout" value="<?php say($r[0]['checkout']);?>">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Date Visited</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="date" placeholder="choose date" name="datevisited" value="<?php say($r[0]['datevisited']);?>">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Purpose</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="text" placeholder="Purpose for the visit" name="purpose" value="<?php say($r[0]['purpose']);?>">
															</div>
                                                        </div>
                                                        <div class="form-group row">
															<label class="col-3">Remark's</label>
															<div class="col-9">
																<input class="form-control form-control-solid" type="text" placeholder="Remarks" name="remarks" value="<?php say($r[0]['remarks']);?>">
															</div>
														</div>
														<div class="form-group row">
															...
															<div class="col-9">
																<div class="input-group input-group-solid">
																	...
																	<input type="text" class="form-control form-control-solid"  placeholder="Phone" name="phone" value="<?php say($r[0]['phone']);?>">
																</div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-9">
                                                                <input class="form-control form-control-solid" type="text" placeholder="P.O. Box 283 8562 Fusce Rd." name="address1" value="<?php say($r[0]['address1']);?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-3">Address Line 2</label>
                                                            <div class="col-9">
                                                                <input class="form-control form-control-solid" type="text" placeholder="8562 Fusce Rd." name="address2" value="<?php say($r[0]['address2']);?>">
                                                            </div>
                                                        </div>
                                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="widget-footer text-right">
                                                <button type="submit" class="btn btn-primary mr-2" id="iss">Submit</button>
                                                <button type="reset" class="btn btn-outline-primary">Cancel</button>
                                            </div>
                                        </div> 
                                    </div>
