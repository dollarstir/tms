                                                                    ...
                                                                    <div class="form">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <select class="form-control" name="cid">
                                                                                            ...
                                                                                            $g = new Sel();
                                                                                            // $ff = new folop();
                                                                                            $response = $g->getall('staff');
                                                                                            // foreach($response as )
                                                                                            Folop::foe($response,function($ss){
                                                                                               return  '<option  value="'.$ss['id'].'">'.$ss['name'].'</option>';



                                                                                            });

                                                                                            // Folop::folo(1,5,function($i){
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number" class="form-control mb-4" placeholder="amount" value="" name="amount">
                                                                                </div>
                                                                            </div> 
                                                                                            <div class="col-md-6">
                                                                                                <select class="form-control mb-4" name="month">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <select class="form-control mb-4" name="year">
                                                                                                    <option valu="">Year</option>
                                                                                                    <?php 
                                                                                                        Folop::folo(2010,2070,function($i){
                                                                                                            return  '<option  value="'.$i.'">'.$i.'</option>';
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <select class="form-control mb-4" name="ptype">
                                                                                                    <option valu="">Payment type</option>
                                                                                                    <option value="Part payment">Full Payment</option>
                                                                                                    <option value="Full Payment">Part Part</option>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="date" class="form-control mb-4" placeholder="Date added" value="" name="dateadded">
                                                                                </div>
                                                                            </div> 
