...
<head>
    ...
    <title>TUCC - Edit Events Executed </title>
                                            ...
                                            <div class="statbox widget box box-shadow mb-4">
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    ...
                                                    <label class="col-3">Event Title</label>
                                                        <div class="mt-2">
                                                            <input type="text" name="title" placeholder="Event Title"  class="form-control mb-3"  value="<?php say($r[0]['title']);?>"/> 
                                                            <label class="col-3">Venue</label>
                                                                <input type="text" name="venue" placeholder="Venue"  class="form-control mb-3"  value="<?php say($r[0]['venue']);?>"/> 
                                                                <label class="col-3">Rate(Ghc)</label>                                                    
                                                                <input type="number" name="rate" placeholder="Rate"  class="form-control mb-3"  value="<?php say($r[0]['rate']);?>"/>
                                                    <div class="form-group row">
                                                        <label class="col-3">Date</label>
                                                        <div class="col-9">
                                                            <input class="form-control form-control-solid" type="date" name="edate"  value="<?php say($r[0]['edate']);?>">
                                                        </div>
                                                    </div>
                                            
                                                    <label class="col-3">Days Taken</label>
                                                    <input type="number" name="edays" placeholder="Days Taken"  class="form-control mb-3"  value="<?php say($r[0]['edays']);?>"/> 
                                                    <input type="hidden" name="id" placeholder="Days Taken"  class="form-control mb-3"  value="<?php say($r[0]['id']);?>"/> 

                                                    <label class="col-3">Total Males</label>
                                                    <input type="number" name="males" placeholder="Male Attendance"  class="form-control mb-3"  value="<?php say($r[0]['males']);?>"/> 
                                                    <label class="col-3">Total Females</label>
                                                    <input type="number" name="females" placeholder="Female Attendance"  class="form-control mb-3" value="<?php say($r[0]['females']);?>" /> 
                                                    <label class="col-3">Total Attendance</label>
                                                    <input type="number" name="total" placeholder="Total Attendance"  class="form-control mb-3" value="<?php say($r[0]['total']);?>"/> 
                                                    <label class="col-3">Name of Speaker</label>
                                                    <input type="text" name="speaker" placeholder="Speaker"  class="form-control mb-3" value="<?php say($r[0]['speaker']);?>"/> 
                                                    <label class="col-3">Repaort</label>
                                                    <textarea  name="report" placeholder="State Of Report"  class="form-control mb-3" ><?php say($r[0]['report']);?></textarea> 
