...
<head>
    ...
    <title>TUCEE  | Edit Customers - </title>
                        ...
                        <div class="row">
                            <div class="container p-0">
                                <div class="row layout-top-spacing">
                                    ...
                                    <?php
                                        $g = new Sel();
                                       $r= $g->select('customers',[['id','=',$_GET['id']]]);
                                    ...
                                    <div class="col-lg-12 layout-spacing">
                                        <div class="statbox widget box box-shadow mb-4">
                                            <form class="editcustomer">
                                                <div class="widget-header">
                                                    <div class="row">
                                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                            <br>
                                                            <div class="makeitSticky z">
                                                              <center>  <h4>Edit Customer  <?php say($r[0]['organization']);?> record</h4></center>
                                                            </div>
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    <div class="w-100">
                                                        ...
                                                        <label class="col-3">Organization Name</label>
                                                            ...
                                                            <label class="col-3">Contact personal Name</label>
                                                            <div class="form-group row">
                                                                <div class="col-9">
