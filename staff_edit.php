...
<head>
    ...
    <title>TUCEE | Edit Staff <?php echo $data[0]; ?> </title>
    ...
    <link href="/tms/assets/css/forms/multiple-step.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            ...
            $g = new Sel();
            $user = $g->select('staff', [['id', '=', $data[0]]]);
            $ss = explode(' ', $user[0]['name']);
            $fname = $ss[0];
            $lname = $ss[1];
                                            ...
                                            <div class="widget-header">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                      <center>  <h3><?php say($user[0]['name']); ?> Record</h3></center>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card multiple-form-one px-0 pb-0 mb-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mx-0">
                                                                    <form id="msform" class="editstaff">
                                                                        <ul id="progressbar">
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-card">
                                                                                ...
                                                                                <input type="text" name="name" placeholder=" Name"  class="form-control mb-3" value="<?php say($user[0]['name']); ?>" /> 
                                                                                <label class="col-3">Email</label>
                                                                                <input type="email" name="email" placeholder="Email"  class="form-control mb-3" value="<?php say($user[0]['email']); ?>" /> 
                                                                                ...
                                                                                <label class="col-3">Phone Number</label>
                                                                                    ...
                                                                                    <input type="text" name="contact" placeholder="Contact No."  class="form-control" value="<?php say($user[0]['contact']); ?>" /> 
                                                                                </div>
                                                                                <div class="input-group mb-3">
                                                                                <label class="col-3">Alternate Number</label>
                                                                                    ...
                                                                                    <input type="number" name="contact2" placeholder="Alternate Contact No." class="form-control" value="<?php say($user[0]['contact2']); ?>" />
                                                                                    <input type="hidden" name="id" placeholder="Alternate Contact No." class="form-control" value="<?php say($user[0]['id']); ?>" />
                                                                                </div>
                                                                                <label class="col-3">SSNT</label>
                                                                                <input type="number" name="ssnt" placeholder="SSNT"  class="form-control mb-3" value="<?php say($user[0]['ssnt']); ?>" />
                                                                                <div class="form-group row">
                                                                                    <label class="col-3">Date Of Birth</label>
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="" name="dob" value="<?php say($user[0]['dob']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id="month" name="gender" value="<?php say($user[0]['gender']); ?>">
                                                                                        <option value="<?php say($user[0]['gender']); ?>"><?php say($user[0]['gender']); ?></option>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id="" name="mstatus" value="<?php say($user[0]['mstatus']); ?>">
                                                                                        <option value="<?php say($user[0]['mstatus']); ?>"><?php say($user[0]['mstatus']); ?></option>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id="month" name="religion" value="<?php say($user[0]['religion']); ?>">
                                                                                        <option value="<?php say($user[0]['religion']); ?>"><?php say($user[0]['religion']); ?></option>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-2 align-center d-flex"> 
                                                                                        <label class="pay mb-0">Staff Status</label> 
                                                                                    </div>
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id="month" name="status" value="<?php say($user[0]['status']); ?>">
                                                                                        <option value="<?php say($user[0]['status']); ?>"><?php say($user[0]['status']); ?></option>
                                                                                        <option value="active">Active</option>
                                                                                            <option value="inactive">Inactivve</option>
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="P.O. Box 283 8562 Fusce Rd." name="address" value="<?php say($user[0]['address']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <label class="col-3">Disability</label>
                                                                                <input type="text" name="disorder" placeholder="Any Disability"  class="form-control mb-3" value="<?php say($user[0]['disorder']); ?>" />
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id="month" name="hedu" value="<?php say($user[0]['hedu']); ?>">
                                                                                        <option value="<?php say($user[0]['hedu']); ?>"><?php say($user[0]['hedu']); ?></option>
                                                                                ...
                                                                                <br> 
                                                                                <label class="col-3">Institutioin</label>
                                                                                <input type="text" name="hinstitute" placeholder="Institutioin"  class="form-control mb-3" value="<?php say($user[0]['hinstitute']); ?>"/> 
                                                                                <label class="col-3">Program Studied</label>
                                                                                <input type="text" name="program" placeholder="Program Studied"  class="form-control mb-3" value="<?php say($user[0]['program']); ?>"/> 
                                                                                <div class="row">
                                                                                    <div class="col-7">
                                                                                        <h5 class="fs-title mb-4">Profile Pic:</h2>
                                                                                    </div>
                                                                                    <!-- <div class="col-5">
                                                                                ...
                                                                                <div class="attached-files">
                                                                                    <img id="image-preview" width="320" src="/tms/upload/<?php say($user[0]['pic']); ?>">
                                                                                </div>
                                                                                ...
                                                                                <embed src="/tms/upload/<?php say($user[0]['pic']); ?>" style="width:150px;height:150px;"><br>
                                                                                <input id="file-upload" name='pic' type="file" accept="image/*"  onchange="handleFileChange()" value="<?php say($user[0]['pic']); ?>">
                                                                                <br><br><br>
                                                                                ...
                                                                                <embed  src="/tms/upload/<?php say($user[0]['doc']); ?>" width="100%" height="400">
                                                                                <br><br><br>
                                                                                <input id="fp" name='doc' type="file" style="" value="<?php say($user[0]['doc']); ?>"><br><br>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id=""  name="department" value="<?php say($user[0]['department']); ?>">
                                                                                            <option value="<?php say($user[0]['department']); ?>"><?php say($user[0]['department']); ?></option>
                                                                                ...
                                                                                <input type="text" name="jobtitle" placeholder="Job Title"  class="form-control mb-3" value="<?php say($user[0]['jobtitle']); ?>" />
                                                                                <div class="form-group row">
                                                                                    <label class="col-3">Date Started</label>
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="" name="datestarted" value="<?php say($user[0]['datestarted']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label class="col-3">Confirmation Date</label>
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="" name="cfirmdate" value="<?php say($user[0]['cfirmdate']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group row">
                                                                                    <label class="col-3">Exit Date</label>
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="" name="exitdate" value="<?php say($user[0]['exitdate']); ?>">
                                                                                    </div>
                                                                                </div> 
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-10"> 
                                                                                        <select class="list-dt" id="" name="slevel" value="<?php say($user[0]['slevel']); ?>">
                                                                                            <option valu="<?php say($user[0]['slevel']); ?>"><?php say($user[0]['slevel']); ?></option>
                                                                                ...
                                                                                <br>
                                                                                <label class="pay mb-0">Salary Amount (Ghc)</label> 
                                                                                <input type="number" name="samount" placeholder="Salary Amount"  class="form-control mb-3" value="<?php say($user[0]['samount']); ?>"/>
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-card">
                                                                                ...
                                                                                <input type="text" name="ename" placeholder="Name"  class="form-control mb-3" value="<?php say($user[0]['ename']); ?>"  /> 
                                                                                <!-- <input type="text" name="elname" placeholder="Last Name"  class="form-control mb-3" />  -->
                                                                                <label class="col-3">Relation</label>
                                                                                <input type="text" name="erelation" placeholder="Relation"  class="form-control mb-3" value="<?php say($user[0]['erelation']); ?>" /> 
                                                                                <div class="form-group row">
                                                                                    <label class="col-3">Residential Address</label>
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="eg : Oyarifa school junction" name="eaddress" value="<?php say($user[0]['eaddress']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group mb-3">
                                                                                <label class="col-3">Phone</label>
                                                                                    ...
                                                                                    <input type="number" name="econt1" placeholder="Contact No."  class="form-control" value="<?php say($user[0]['econt1']); ?>" /> 
                                                                                </div>
                                                                                <div class="input-group mb-3">
                                                                                <label class="col-3"> Alternate Phone</label>
                                                                                    <div class="input-group-prepend">
                                                                                        <span class="input-group-text"><i class="las la-phone font-17"></i></span>
                                                                                    </div>
                                                                                    <input type="number" name="econt2" placeholder="Alternate Contact No." class="form-control" value="<?php say($user[0]['econt2']); ?>"/>
                                                                                </div>
                                                                                <br><br>
                                                                                <h5 class="fs-title mb-4">Next of Kin</h5>
                                                                                <label class="col-3">Name</label>
                                                                                <input type="text" name="nokname" placeholder=" Name"  class="form-control mb-3" value="<?php say($user[0]['nokname']); ?>"/> 
                                                                                <!-- <input type="text" name="noklname" placeholder="Last Name"  class="form-control mb-3" />  -->
                                                                                <label class="col-3">Relation</label>
                                                                                <input type="text" name="nokrelation" placeholder="Relation"  class="form-control mb-3"  value="<?php say($user[0]['nokrelation']); ?>"/> 
                                                                                <div class="form-group row">
                                                                                    <label class="col-3">Residential Address</label>
                                                                                    <div class="col-9">
                                                                                        <input class="form-control form-control-solid" type="text" placeholder="P.O. Box 283 8562 Fusce Rd." name="nokaddress" value="<?php say($user[0]['nokaddress']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group mb-3">
                                                                                    <label class="col-3">Phone</label>
                                                                                    ...
                                                                                    <input type="number" name="nokcont1" placeholder="Contact No."  class="form-control" value="<?php say($user[0]['nokcont1']); ?>" /> 
                                                                                </div>
                                                                                <div class="input-group mb-3">
                                                                                    <label class="col-3">Alternate Phone</label>
                                                                                    <div class="input-group-prepend">
                                                                                    ...
                                                                                    <input type="number" name="nokcont2" placeholder="Alternate Contact No." class="form-control" value="<?php say($user[0]['nokcont2']); ?>" />
                                                                                </div>
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="form-card">
                                                                                ...
                                                                                <input type="text" name="bankname" placeholder="" class="form-control mb-3" value="<?php say($user[0]['bankname']); ?>"/>
                                                                                <label class="pay">Branch</label> 
                                                                                <input type="text" name="branch" placeholder="" class="form-control mb-3" value="<?php say($user[0]['branch']); ?>"/>
                                                                                <label class="pay">Account Name</label> 
                                                                                <input type="text" name="accname" placeholder="" class="form-control mb-3" value="<?php say($user[0]['accname']); ?>"/>
                                                                                <label class="pay">Account Number</label> 
                                                                                <input type="text" name="accnumber" placeholder="" class="form-control mb-3" value="<?php say($user[0]['accnumber']); ?>"/>
    ...
    <script src="/tms/assets/js/forms/multiple-step.js"></script>
