...
<head>
    ...
    <title>TUCEE - Add Bookings </title>
                        ...
                        <li>
                            <div class="page-header">
                                <nav class="breadcrumb-one" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0);">Booking Info</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"><span>Add Booking Info</span></li>
                                    </ol>
                                </nav>
                            </div>
                        </li>
                                                    ...
                                                    <div class="w-100">
                                                        <div class="mt-2">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-solid" type="date"  name="bookdate">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-3">Time</label>
                                                                <div class="col-9">
                                                                    <input class="form-control form-control-solid" type="time"  name="booktime">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <br>
                                                    <input type="text" name="assigned" placeholder="Assigned Counsellor"  class="form-control mb-3" /> 
                                                    <input type="text" name="hyh" placeholder="How you heard of TUCEE"  class="form-control mb-3" /> 
